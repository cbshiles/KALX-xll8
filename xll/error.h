...
#pragma comment(linker, "/include:" XLL_DECORATE("xll_alert_error_toggle", 0))
#pragma comment(linker, "/include:" XLL_DECORATE("xll_alert_warning_toggle", 0))
#pragma comment(linker, "/include:" XLL_DECORATE("xll_alert_info_toggle", 0))
